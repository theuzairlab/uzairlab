          ...
          >
            ...
            <form className='flex gap-2'>
              <input
                ...
                className='flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-[#C9F31D] text-white'
              />
              <button
                type="submit"
                className='px-4 py-2 bg-[#C9F31D] text-black font-medium rounded-lg hover:bg-[#d4ff33] transition-colors'
              >
                Subscribe
              </button>
            </form>
